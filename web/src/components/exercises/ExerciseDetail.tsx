...
function MuscleBody({
  ...
  return (
    <svg width={width} height={width * 1.5} viewBox="0 0 100 150" fill="none" aria-hidden="true">
      ...
      <path
        d="M36 22 Q50 24 64 22 L68 36 Q70 48 68 62 Q65 74 62 82 L38 82 Q35 74 32 62 Q30 48 32 36 Z"
        fill={body}
        stroke={out}
        strokeWidth="0.7"
      />
      <path
        d="M36 24 L28 30 Q24 38 26 52 L31 54 Q34 42 37 36 Z"
        fill={body}
        stroke={out}
        strokeWidth="0.7"
      />
      <path
        d="M64 24 L72 30 Q76 38 74 52 L69 54 Q66 42 63 36 Z"
        fill={body}
        stroke={out}
        strokeWidth="0.7"
      />
    ...
    >
      <div
        style={{
          ...
          height: 120,
          background:
            "radial-gradient(ellipse at 50% 100%, rgba(255,107,53,0.18), transparent 70%)",
          pointerEvents: "none",
        }}
      />
      {image ? (
...
export default function ExerciseDetail({ exercise }: { exercise: Exercise }) {
  ...
  return (
    <div className="screen">
      ...
      {/* Tabs */}
      <div
        style={{ display: "flex", borderBottom: "1px solid var(--border-1)", padding: "0 20px" }}
      >
          ...
          <>
            ...
            >
              <div
                style={{
                  ...
                  flexShrink: 0,
                  background:
                    "radial-gradient(circle at 32% 32%, #FFC9A8, var(--ai-accent) 55%, #9A2E10)",
              ...
              <div>
                ...
                <div style={{ fontSize: 13, lineHeight: 1.4, color: "var(--fg-0)" }}>
                  Basert på dine siste tre sesjoner — prøv 2.5 kg over forrige gang. Bar-hastigheten
                  har vært sterk.
                </div>
              </div>
            </div>
            ...
            >
              <div className="card" style={{ padding: 12 }}>
                ...
                <div className="metric" style={{ marginTop: 8, fontSize: 22 }}>
                  {exercise.pr}
                </div>
            ...
            <div className="card" style={{ padding: 14, marginTop: 14 }}>
              ...
              >
                ...
                <text x="2" y="88" fontSize="9" fill="var(--fg-3)">
                  Apr &apos;25
                </text>
                <text x="155" y="88" fontSize="9" fill="var(--fg-3)" textAnchor="middle">
                  Okt &apos;25
                </text>
                <text x="316" y="88" fontSize="9" fill="var(--fg-3)" textAnchor="end">
                  Apr &apos;26
                </text>
              </svg>
