...
export const EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    view: "back",
    description:
      "Starting position: Stand facing a chair. Steps: Step up onto the chair. Step off the chair. Repeat.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Grab the handles of the TRX straps, lean your body back, arms and legs extended, with your body positioned in a single straight line. (This is an arm exercise, not an abdominal one.)",
  ...
  },
  {
    ...
    primary: "Shoulders",
    secondary: ["Quads", "Abs"],
    highlight: ["shoulders", "quads", "abs", "upperBack"],
    view: "front",
    description:
  ...
  },
  {
    ...
    highlight: ["shoulders", "glutes", "lats", "abs", "quads", "upperBack"],
    view: "front",
    description:
  ...
  },
  {
    ...
    view: "front",
    description:
      "The 90° leg raise on the bar is a very intense exercise that involves all the abdominal muscles.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Place a barbell on the floor at your feet. Bending at the waist, grip the barbell with a shoulder with overhand grip. With a slow controlled motion, roll the bar out so that your back is straight. Roll back up raising your hips and butt as you return to the starting position.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    equipment: "Bodyweight",
    primary: "Glutes",
    secondary: ["Biceps", "Abs", "Triceps"],
    highlight: ["glutes", "biceps", "abs", "triceps"],
    view: "back",
    description:
  ...
  },
  {
    ...
    view: "back",
    description:
      "Starting positionStand straight. Steps: Run in place, putting knees as high up as is comfortable and switching legs at a quick pace.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Starting position: Sit upright on a chair or a firm pillow. Steps: Breathe out and tilt your head forward, chin to chest, putting hands behind your head. Use your hands to pull your head down lightly and press against your hands with your head to balance out the force. Hold for a bit. Relax your arms and head, opening up a bit with your shoulders. Keep repeating this from step 2 onward.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    equipment: "Bodyweight",
    primary: "Shoulders",
    secondary: ["Biceps", "Hamstrings", "Lats", "Abs"],
    highlight: ["shoulders", "biceps", "hamstrings", "lats", "abs"],
    view: "front",
    description:
      "BLAZE is a full-body HIIT workout. Designed to supercharge your cardio fitness and strength. Delivered in its own purpose-built studio, BLAZE is a unique mix of martial arts, intense cardio and strength training.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    equipment: "Bodyweight",
    primary: "",
    secondary: ["Hamstrings", "Glutes", "Lats", "Quads"],
    highlight: ["abs", "hamstrings", "biceps", "glutes", "lats", "quads"],
    view: "front",
    description:
  ...
  },
  {
    ...
    primary: "Hamstrings",
    secondary: ["Abs"],
    highlight: ["hamstrings", "abs", "chest"],
    view: "back",
    description:
  ...
  },
  {
    ...
    view: "back",
    description:
      "Set up bench in front of cable row machine. Lean over bench to do a row/pullover with rope that targets lats. See picture.",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Sitting on the ground, use a high cable in a single grip, to do lat pulldowns with a focus on a long stretch in the lats.",
  ...
  },
  {
    ...
    view: "front",
    description:
      "This exercise involves lifting a barbell from the ground to the shoulders, then pressing it overhead. It is a compound movement that targets multiple muscle groups, including the legs, back, shoulders, and arms. It is often used in strength and conditioning programs to improve overall power and athleticism.",
  ...
  },
  {
    ...
    highlight: ["shoulders", "chest", "triceps"],
    view: "front",
    description: "",
    image: "",
    tips: [],
  ...
  },
  {
    ...
    view: "back",
    description:
      "This is an excercise for problems with the levator muscles. Primary Infraspinatus, secondary Teres Minor. Lying on side. Keep elbow on waist and in 90 dgr angle. Rotate towards stomach. Add weight as fit.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Lying on stomach with head on towel. Stretch arms straight out to your sides. Slowly lift your arms, pulling your shoulderblades together, hold for 3 seconds.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "With an inclined bench in front of the pulldown machine, use a close-grip to do latfocused pulldowns.",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Place the forearm vertically on a door frame or stationary object at head height Step forward past the arm, keeping it still against the object to stretch the chest",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Sit down and hold the bar firmly with your hands. Now press the weight upwards (don't fully extend your arms) and lower it slowly again. As with other triceps exercises, it's important not to move your upper arms.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    highlight: ["shoulders", "glutes", "abs", "chest"],
    view: "front",
    description:
  ...
  },
  {
    ...
    view: "back",
    description:
      "Starting position: Kneel in front of a bench, far enough so that your torso can fit between your knees and the bench. With your back straight, place your elbows on the bench, with palms together, hands pointing up. Steps: On exhale, stretch your chest down toward the floor without moving your lower back. At the same time, bring your hands toward your shoulders, keeping palms together and elbows on the bench. Hold for a few seconds. On inhale, relax your back to return to the starting position. Repeat.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      'Exercise to strengthen the shoulders and pectorals. Its name is due to the fact that it begins in the Yoga position "Dog Facing Down", passing to "Cobra" but without resting the legs or torso on the ground to finally end with a normal flexion. The exercise can also be performed backwards (back to the starting position). As a variation, after doing the push-up, the hip can be raised to return to downward facing dog.',
  ...
  },
  {
    ...
    highlight: ["biceps", "shoulders", "triceps"],
    view: "front",
    description:
  ...
  },
  {
    ...
    view: "front",
    description:
      "In the correct plank position, place your feet slightly wider than shoulder-width apart. alternately lift and touch the opposite shoulder with one hand.",
  ...
  },
  {
    ...
    view: "back",
    description:
      "With an inclined bench in front of the cable row machine, do onehanded rows with focus on a big stretch in the lats.",
  ...
  },
  {
    ...
    highlight: ["glutes", "shoulders", "abs"],
    view: "back",
    description:
  ...
  },
  {
    ...
    view: "front",
    description:
      "The machine lateral raise is an isolation exercise that targets the medial (side) deltoid muscle to build wider, more defined shoulders. The machine's fixed path of motion provides greater stability than dumbbells, making it ideal for beginners or those who want to focus solely on muscle activation.",
  ...
  },
  {
    ...
    view: "front",
    description:
      ". It provides an effective but straightforward way to work your upper body. With no weights to balance and no tricky techniques to master, the chest press leaves you free to focus on your training.",
  ...
  },
  {
    ...
    view: "back",
    description:
      "This exercise involves holding a dumbbell in each hand and bending forward at the hips while keeping the back straight, then returning to a standing position. It primarily targets the hamstrings and glutes.",
  ...
  },
  {
    ...
    highlight: ["lats", "shoulders", "biceps"],
    view: "back",
    description:
  ...
  },
  {
    ...
    equipment: "Machine",
    primary: "Shoulders",
    secondary: ["Biceps", "Chest", "Abs"],
    highlight: ["shoulders", "biceps", "chest", "abs", "upperBack"],
    view: "front",
    description:
  ...
  },
  {
    ...
    equipment: "Bodyweight",
    primary: "Abs",
    secondary: ["Shoulders", "Biceps", "Glutes", "Lats"],
    highlight: ["abs", "shoulders", "biceps", "glutes", "lats"],
    view: "front",
    description:
  ...
  },
  {
    ...
    view: "back",
    description:
      "Movimiento descendente • Tire de la barra hacia abajo para que pase cerca de su barbilla y toque la parte superior de su pecho. • Mantenga el resto de su cuerpo inmóvil.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Exercises for strengthening knee and leg musculature. Lateral Wall Drills March - https://youtu.be/9RiTlJ6Mmek Lateral Wall Drills OPEN - https://youtu.be/ADRlN8-Wfdg Lateral Wall Drills CROSS - https://youtu.be/hGH2sj0Tzu4",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Biceps",
    secondary: ["Chest", "Abs"],
    highlight: ["biceps", "chest", "abs", "upperBack"],
    view: "front",
    description:
  ...
  },
  {
    ...
    highlight: ["quads", "hamstrings", "calves", "glutes"],
    view: "front",
    description:
  ...
  },
  {
    ...
    equipment: "Bodyweight",
    primary: "",
    secondary: ["Shoulders", "Hamstrings", "Glutes", "Abs"],
    highlight: ["upperBack", "shoulders", "hamstrings", "glutes", "abs"],
    view: "back",
    description:
      "Lay flat on your stomach with your arms extended in front of you on the ground as your legs are lying flat. Lift both your arms and move them to your side slowly. Then, move them back.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Find a few specific edge sizes on a hangboard, get fixed underneath them with the board overhead, and pull with max effort, 1 arm at a time, for 3-5 seconds. When positioning for this get set up with a large elbow angle (120-150 degrees) and not in full extension.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Lean forward to rest your hand on a chair or other object, holding a dumbbell in the other hand Gently swing the dumbbell in a circular motion",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Lie on your side holding a dumbbell in your upper hand Tuck your elbow into your side and rest the hand in front of you Rotate the shoulder so the hand raises up Lower the hand down",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Hold a dumbbell in each hand with your palms facing forward. Pull your elbows back and lift the dumbbells to your chest height. Slowly lower the dumbbell and repeat the exercise.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Place your hands on the bench in a press up position Push your chest away from the bench to separate your shoulder blades Keeping your elbows straight, lower your chest towards the bench so your shoulder blades move closer together Push your chest away from the bench again",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Hold a dumbbell in each hand with your hands slightly wider than shoulder-width apart and palms facing forward. Bend your elbows and lift the dumbbells to your shoulders. Slowly return and repeat.",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Unilateral triceps exercise with your back to the pulley, with the pulley at the top",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Hold a dumbbell in each hand. Bend at your hips to make your back almost parallel to the floor. Let your arms hang down. Keep your arms in line with your shoulders. bend and lift your elbows out to the sides until your upper arms are parallel to the floor. Slowly return and repeat",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Hold a dumbbell in each hand in front of your body. Keep your palms towards your body. Lift you hands straight up until your hands are under your chin, then lower them. Repeat the exercise.",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Stand with your left arm close to a wall. Extend your left arm and put your left hand on the wall, then gently turn your body to the right.",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Stand with your right arm close to a wall. Extend your right arm and put your left hand on the wall, then gently turn your body to the right.",
  ...
  },
  {
    ...
    highlight: ["glutes", "hamstrings", "quads"],
    view: "back",
    description:
  ...
  },
  {
    ...
    view: "back",
    description:
      "This stretch targets the gastrocnemius (the chief muscle of the calf of the leg, which flexes the knee and foot). It is easy to perform anywhere. All you need is a wall or a chair.",
  ...
  },
  {
    ...
    equipment: "Bodyweight",
    primary: "Shoulders",
    secondary: ["Biceps", "Hamstrings", "Calves", "Lats", "Abs"],
    highlight: ["shoulders", "biceps", "hamstrings", "calves", "lats", "abs"],
    view: "front",
    description:
  ...
  },
  {
    ...
    view: "back",
    description:
      "This stretch targets the Soleus part of your calf. It may be performed with a wall or chair.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "This exercise uses an exercise band. It targets the Soleus and Tibialis anterior.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Banded plantarflexion is a great way to bridge the gap between plantarflexion range of motion and the more strenuous calf raises in weight bearing. This can help strengthen the calf muscles, load the Achilles tendon, and improve plantarflexion range of motion.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "The double leg heel raise is important to strengthen and create control and stability around the ankle and knee, and provide balance and control for the hip and pelvis.",
  ...
  },
  {
    ...
    view: "back",
    description:
      "The front lever is a figure where the body is kept in a horizontal position parallel to the floor.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "sostener las empuñaduras con las manos, alargar los brazos y mantenerlos paralelos a la altura del pecho. El movimiento que debes realizar es una abertura de los brazos alineados con los hombros mientas inclinas el cuerpo hacia delante. Intenta no realizar una extensión de hombro más allá de los 90º y mantén contraída la musculatura abdominal y los glúteos. Músculos implicados: Transverso, recto abdominal y erectores espinales",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "From the final phase of a pull-up, we push ourselves back with our shoulders until we reach the front lever position. From there, we pull ourselves back up to the starting position.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "in the front lever position, with legs extended or easier if collected, pull by bringing the chest closer to the bar.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "The muscles involved in the Front Lever, most subjected to stress, are mainly the extensors such as: the latissimus dorsi, the teres major, the posterior deltoid and the long head of the biceps.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    highlight: ["abs", "shoulders", "chest"],
    view: "front",
    description:
      "Place your feet in the stirrups and assume a high plank with your hands directly beneath your shoulders. Pull your knees to your right elbow, then push them back out and to the centre.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Place the grips as if they were a continuation of the straps. We will position our arms stretched forward and our body leaning back, completely straight. The biceps muscles will activate as you bend your elbows to bring your body towards the straps. The contraction movement will end with a slight outward movement of the hands, due to the grip we are using.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Biceps",
    secondary: ["Shoulders"],
    highlight: ["biceps", "shoulders", "upperBack"],
    view: "front",
    description:
      "Step 1: Stand comfortably and grasp the handles of the suspension system. Step 2: Lean back resting your weight on one arm, keepng the spine neutral. Step 3: Slowly curl to pull your body weight to the up position. Supinate the arm and squeeze as you approach the end position. Step 4: Lower yourself back down and repeat.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    equipment: "Bodyweight",
    primary: "Back",
    secondary: ["Shoulders", "Hamstrings", "Calves", "Lats", "Triceps"],
    highlight: ["shoulders", "hamstrings", "calves", "lats", "upperBack", "triceps"],
    view: "back",
    description:
  ...
  },
  {
    ...
    primary: "Triceps",
    secondary: ["Chest"],
    highlight: ["triceps", "chest"],
    view: "back",
    description:
      "Start with the hands on the suspension trainer and feet on the ground. Your hands should be under your shoulders with the feet slightly in front. Lower yourself by bringing the hips between the handles and flexing the elbows. Extend the elbows to come back to the starting position and repeat.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "The dumbbell chest press is a pressing exercise similar to the barbell bench press, except that it is performed with dumbbells.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "La planche latérale dynamique implique de se placer sur le côté, en appui sur un coude et le côté du pied, puis de basculer les hanches de haut en bas tout en maintenant une ligne droite du corps.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Nello specifico i muscoli coinvolti sono: bicipite femorale. muscolo semimembranoso. muscolo semitendinoso.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Single arm curl that can be done using a dumbbell and a preacher bench, or a preacher curl machine. Turn body towards the weight",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    equipment: "Barbell",
    primary: "Triceps",
    secondary: ["Biceps", "Chest"],
    highlight: ["triceps", "biceps", "chest"],
    view: "back",
    description:
  ...
  },
  {
    ...
    view: "back",
    description:
      "A single arm exercise that starts with the hand close to the chest with with the elbows bent, and the elbow flared out. Press forward and down against the cable straightening the elbow.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "single arm exercise with cable held at opposite shoulder with elbow bent. Turn towards the cable, and the straighten the elbow across the body.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "single arm exercise with cable held at opposite shoulder with elbow bent. Turn away from the cable, and the straighten the elbow across the body.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Place elbow so that it is about level with the shoulder. Curl the wieght to your shoulder. Focus on the stretch in the eccentric part of the curl",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    equipment: "Bodyweight",
    primary: "",
    secondary: ["Hamstrings", "Calves", "Lats"],
    highlight: ["abs", "hamstrings", "calves", "lats"],
    view: "front",
    description:
  ...
  },
  {
    ...
    view: "front",
    description:
      "Diese Maschine neben Beinheben. Kopf nach vorne, mit dem gesicht zum boden und das Gewicht aufheben",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Push off the ground and land on one leg and regain balance before jumping to the other leg",
  ...
  },
  {
    ...
    highlight: ["hamstrings", "glutes", "quads"],
    view: "back",
    description:
      "Stand tall next to a wall or stable support. Swing one leg forward and backward in a controlled motion, keeping the torso upright and the core engaged. Alternate legs after completing the repetitions.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Ellbogen fixieren Muskulatur anspannen Kein Schwung holen Kontrollierte Bewegung Langsame Bewegung Immer angewinkelt lassen Nicht überdehnen",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Lie on a flat bench and press dumbbells upward until arms are fully extended, then lower them slowly.",
  ...
  },
  {
    ...
    primary: "",
    secondary: ["Shoulders"],
    highlight: ["upperBack", "shoulders"],
    view: "back",
    description:
      "The Wall Angels exercise primarily targets the upper back and shoulder muscles, helping improve posture, shoulder mobility, and scapular control.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Muskulatur anspannen Hintern ein wenig anheben Kontrollierte Bewegung Langsame Bewegung Kein Schwung holen Oberkörper gerade halten",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Muskulatur anspannen Füße Breitpositionieren Kontrollierte Bewegung Langsame Bewegung Gewichte zur unteren Brust/ Bauch führen",
  ...
  },
  {
    ...
    equipment: "Dumbbell",
    primary: "Shoulders",
    secondary: ["Hamstrings", "Glutes", "Lats", "Abs"],
    highlight: ["shoulders", "hamstrings", "glutes", "lats", "abs"],
    view: "front",
    description:
      "Full-body muscles building exercise. This exercise provides a huge range of benefits in terms of strength &amp; size and is extremely functional.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    highlight: ["glutes", "hamstrings", "calves", "abs"],
    view: "back",
    description:
      "The kettlebell front squat is a compound, multi-joint exercise that works several muscle groups.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "slow and controlled movement do not bounce on lower position Kontrollierte Ausführung Kein Schwung holen Langsame Ausführung",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Jump from a standing position onto the box, stretch your body, then step down again (do not jump)",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "For this exercise Recumbent Bike is needed. You just sit on it, set level and time and start the workout",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    highlight: ["shoulders", "biceps", "lats"],
    view: "front",
    description:
      "Upper Back is suitable for building up the core muscles with a special focus on the deltoid and rhomboid muscles and the upper back muscles",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    equipment: "Bodyweight",
    primary: "Chest",
    secondary: ["Shoulders", "Abs", "Triceps"],
    highlight: ["chest", "shoulders", "abs", "triceps"],
    view: "front",
    description:
  ...
  },
  {
    ...
    view: "front",
    description:
      "With your palms facing forward, curl the weights up to your shoulders. Turn your hands so that that your palms downwards and slowly return the weights back down. Finally face your palms back forward.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Hamstrings",
    secondary: ["Calves"],
    highlight: ["hamstrings", "calves"],
    view: "back",
    description:
      "Stand with your feet closer together. Hinge at your hips and lower your upper body towards your toes. Reach your hands towards your feet, try to touch your toes, the ground, or as far down your legs as you can comfortably go.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Hamstrings",
    secondary: ["Shoulders"],
    highlight: ["hamstrings", "shoulders"],
    view: "back",
    description:
      "Start with the dumbbells resting on your shoulders and squat down. Push into standing and raise the dumbbells into an overhead position. Bring the dumbbells back to your shoulders and repeat.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    equipment: "Dumbbell",
    primary: "Chest",
    secondary: ["Shoulders", "Biceps", "Hamstrings", "Glutes", "Triceps"],
    highlight: ["chest", "shoulders", "biceps", "hamstrings", "glutes", "triceps"],
    view: "front",
    description:
  ...
  },
  {
    ...
    highlight: ["shoulders", "hamstrings", "calves", "upperBack"],
    view: "front",
    description:
      "Place a dumbbell at around hip level and assume a bear crawl position. Push the knees off the floor and hold. With the opposite hand reach for the dumbbell and pull it to the other side. Place your hand back on the floor and repeat with your other hand.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Assisted triceps dips is a gym work out exercise that targets triceps and also involves chest.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Hinge at your hips until you feel a stretch behind your knees. Bend one leg while the other is straight then fluidly bend the other knee while straightening the first knee.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Stand with your feet more than shoulder-width apart (wider stance) and place your hands on your hips. Hinge at your hips and lower your upper body towards the ground while keeping your back straight then come back up.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Sit on the ground with one leg straight out in front of you and the other leg bent in toward you. Reach forward with both hands, trying to touch the toes of your straight leg.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Core stability. Press lower back into floor. Opposite arm/leg. No hip-flexor load.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Single arm curl that can be done using a dumbbell and a preacher bench, or a preacher curl machine. Turn body away from the weight",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Shoulders",
    secondary: ["Chest"],
    highlight: ["shoulders", "abs", "chest"],
    view: "front",
    description:
      "The Plank-to-Elbow Extension is a dynamic exercise that combines the plank with an elbow extension movement",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "The Cossack Squat is a multi-joint exercise that works mainly on the legs and buttocks, but also involves stabilizing muscles. It is an excellent exercise for improving strength, mobility and stability in a functional way.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "The Wall Sit (or wall chair) is an isometric exercise that mainly involves the leg muscles, improving muscular endurance and stability. Here are the main and secondary muscles activated during the exercise.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    equipment: "Bodyweight",
    primary: "",
    secondary: ["Shoulders", "Glutes", "Lats", "Triceps"],
    highlight: ["abs", "shoulders", "glutes", "lats", "triceps"],
    view: "front",
    description:
  ...
  },
  {
    ...
    view: "front",
    description:
      "Bicycle crunches are a core exercise performed on the floor. Lie on your back with your hands behind your head and legs extended. Lift your shoulders off the ground, bring one knee toward your chest, and twist your torso so your opposite elbow meets the knee. Alternate sides in a pedaling motion, ensuring controlled movements and engaging your core throughout the exercise.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Lats",
    secondary: ["Glutes"],
    highlight: ["lats", "glutes"],
    view: "back",
    description:
      "Bend upper body forward Move dumbbells near your body with slightly bent arms towards your back",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Hang straight on a pull-up bar Pull shoulder blades together, moving the body slightly up",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Set security pins to about the height of your sticking point Lower the bar, rest on the pins for 1s while holding tension Move bar up with maximum force",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Hamstrings",
    secondary: ["Abs"],
    highlight: ["hamstrings", "abs"],
    view: "back",
    description:
      "Set security pins to about the height of your sticking point Lower the bar, rest on the pins for 2s keeping tension Stand up with maximum force",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    equipment: "Barbell",
    primary: "Glutes",
    secondary: ["Hamstrings", "Lats", "Abs"],
    highlight: ["glutes", "hamstrings", "lats", "abs"],
    view: "back",
    description:
      "Regular olympic lift clean. Pull bar from ground, catch on shoulders performing a front squat.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Set security pins to the height of your lower chin Rest bar on pins keeping tension Raise bar over head",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Sit on a bench with 45° incline Ellbows 45° out Move dumbbells down until upper arms are parallel to shoulders Move dumbbells up, meeting overhead",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    equipment: "Dumbbell",
    primary: "Shoulders",
    secondary: ["Biceps", "Chest", "Abs", "Triceps"],
    highlight: ["shoulders", "biceps", "chest", "abs", "triceps"],
    view: "front",
    description:
  ...
  },
  {
    ...
    view: "front",
    description:
      "Bench 45° incline Hold dumbbells parallel on your chest Press up until arms extended",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    equipment: "Barbell",
    primary: "Shoulders",
    secondary: ["Glutes", "Quads", "Triceps"],
    highlight: ["shoulders", "glutes", "quads", "triceps"],
    view: "front",
    description:
      "Olympic lift jerk Hold bar in front on shoulders like push press Bend and extend knees pushing bar up while diving under the bar Catch bar overhead with straight arms using lunge Move feet parallel while holding bar in lockout",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    highlight: ["shoulders", "lats", "abs", "upperBack", "triceps"],
    view: "front",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Olympic lift snatch Pull barbell from ground to overhead lockout using a wide grip and overhead squat. Move bar slowly until cleared knees then explosively extend hips, pull bar up and dive under the bar Catch bar overhead with straight arms Push head forward during lockout",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Sit on bench with 60° incline Hold dumbbells beside body near the ground, palms facing outwards, arms fully extended Move dumbbells up using only biceps and without momentum",
  ...
  },
  {
    ...
    primary: "Lats",
    secondary: ["Shoulders"],
    highlight: ["lats", "shoulders"],
    view: "back",
    description:
      "In this exercise, you lie flat on your stomach, hold a towel with your arms extended in front of you, and pull it apart to create tension. Then, you move it forward and back under your stomach. This exercise targets the back and shoulder muscles as well as core stability.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Shoulders",
    secondary: ["Biceps"],
    highlight: ["shoulders", "biceps", "chest"],
    view: "front",
    description:
  ...
  },
  {
    ...
    view: "front",
    description:
      "Attach a D-Bar to the cable machine. Perform a motion akin to drawing a sword from across your body.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Hack Squats but with a 1-2s pause at the bottom of the movement. This makes sure that there is no more elastic energy stored in the muscles.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Ideally using a trapeze addon, Lift the weight up using your calves by getting on your toes.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Triceps",
    secondary: ["Shoulders", "Chest"],
    highlight: ["triceps", "shoulders", "chest"],
    view: "back",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Allowing you to safely load more weight than a regular skull crusher, lie on the floor and rest the weight on the floor in between each repetition.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Attach a D-Handle to a high pully. And use your lat muscles to pull the weight single handedly.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Attach D-Handles to two cable pulleys in the upper position. Grab the left on with your right hand and vice-versa.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "In this midrange exercise your arm muscles provide you with a little bit of momentum to help to get you off the ground. You also open them up in overhead position which engages the upper back. Start lying with feet flat on the ground, knees at an angle, arms crossed in towards your chest. Using your ab muscles, bring your upper body off the ground as you open your arms into goal post position, then slowly lower yourself back down to return to starting position.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "pegada neutra A remada unilateral, também conhecida como remada serrote, é um exercício que fortalece as costas e os bíceps, além de melhorar a postura.",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Kneeling down on one leg and pulling cable down while driving elbow into the lats.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Dumbbell in hand in a curl fashion, lean body into the arm to help the dumbbell up above the chest, next to the head, to activate chest and delt combo",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Elbows Tucked DB Bench Press, chest press movement focusing on the triceps. DB stays parallel with body",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Alike tricpes extensions, DBs fall down near the head and pushed back up. Unlike for the triceps extension tring to extend the arms as far back",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Dumbbell upper chest variance. Curl like movement up above at head level, activating chest and front delts",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Slightly bent down and knees to mimic a gorilla position and pull/row up the DBs to the chest. DB stay straight (thumbs pointing up)",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Similar to hip thrust, but with feet put up together, lifting the butt off the ground in a frog like position.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Lateral walks, also known as side steps or squat walks, are a type of exercise where you move sideways in a squatting position. They can be performed with or without resistance bands. These exercises strengthen the hip abductors, glutes, and other stabilizing muscles.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Move the leg press using your calves by placing your feet at the bottom of the platform.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    equipment: "Bodyweight",
    primary: "Calves",
    secondary: ["Shoulders", "Hamstrings", "Triceps"],
    highlight: ["calves", "shoulders", "hamstrings", "triceps"],
    view: "back",
    description:
  ...
  },
  {
    ...
    equipment: "Bodyweight",
    primary: "Hamstrings",
    secondary: ["Shoulders", "Biceps", "Chest", "Triceps"],
    highlight: ["hamstrings", "shoulders", "biceps", "chest", "upperBack", "triceps"],
    view: "back",
    description:
      "Hold the ends of the rope at arm's length in front of your hips with your hands shoulder-width apart. Brace your core and begin alternately raising and lowering each arm explosively. Keep alternating arms for three to four sets of 1 to 2 minutes.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Lats",
    secondary: ["Shoulders", "Glutes"],
    highlight: ["lats", "shoulders", "glutes"],
    view: "back",
    description:
  ...
  },
  {
    ...
    equipment: "Bodyweight",
    primary: "Calves",
    secondary: ["Hamstrings", "Glutes", "Quads", "Abs"],
    highlight: ["calves", "hamstrings", "glutes", "quads", "abs"],
    view: "back",
    description:
  ...
  },
  {
    ...
    view: "front",
    description:
      "Place your feet in the middle of the plate at about shoulder width. Tense your torso. Keep your neck relaxed.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Lie down on the back pad and strap yourself in with the waistband. Position yout feet shoulder-length apart. They should be slightly splayed.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Execution Starting position: Hold the barbell with arms fully extended toward the floor. Maintain tension in your lats and back muscles.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Execution Hinge at the hips: Push your hips backward, keeping a slight bend in the knees (soft knees). Lower the barbell along the front of your thighs/shins while maintaining a neutral spine. Keep the bar close to your body.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "The Bulgarian split squat consists of performing a squat on one leg with the rear foot resting on a raised platform. Elevating your back leg on a bench creates instability and increases the range of motion of the exercise.",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Kneel down with the hands together Rest the elbows on a bench in front of you and lower the chest down Keep the elbows bent with good posture and hold",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Starting Position: Kneel on the floor with the ab wheel in front of you. Grip the Wheel: Hold the handles firmly. Roll Out: Slowly roll the wheel forward, extending your body while keeping your core tight. Return: Pull the wheel back towards your knees, maintaining tension in your core.",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Mobility - prone dowel press or standing dowel shoulder press alternating between front andback",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Hamstrings",
    secondary: ["Calves", "Abs"],
    highlight: ["hamstrings", "calves", "abs"],
    view: "back",
    description:
  ...
  },
  {
    ...
    equipment: "Barbell",
    primary: "Hamstrings",
    secondary: ["Calves", "Quads", "Abs"],
    highlight: ["hamstrings", "calves", "quads", "abs"],
    view: "back",
    description:
  ...
  },
  {
    ...
    view: "back",
    description:
      "Finess test for rugby.5 x shuttle runs of 20m, 40m, and 60m (20yd, 45yd, 65yd/far 45yd mark) Complete as fast as possible",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Using a landmine attachment with the barbell running at 90 degrees to either side, hinge slightly at the hips and grip the barbell by the plate sleeve. Raise the barbell to chest height, with your upper arm parallel to the floor at the top of the movement.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Laying flat with arm pointing straight upwards, elbow fully extended, use only your shoulder to raise the weight as high as comfortable and back to rest.",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Laying on your side and using the arm closest to the bench, maintain a 90 degree bend at the elbow and allow the weight to fall towards the ground past the bench as low as comfortable. Bring the weight up using only rotation of the shoulder to the opposing shoulder.",
  ...
  },
  {
    ...
    equipment: "Bodyweight",
    primary: "Hamstrings",
    secondary: ["Shoulders", "Biceps", "Abs", "Triceps"],
    highlight: ["hamstrings", "shoulders", "biceps", "abs", "triceps"],
    view: "back",
    description:
      "Low-impact cardiovascular exercise that simulates running without moving, ideal for warming up, improving endurance, or training in small spaces.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Hamstrings",
    secondary: ["Lats"],
    highlight: ["hamstrings", "lats"],
    view: "back",
    description:
      "Movimientos suaves para mejorar la flexibilidad de la parte inferior del cuerpo y liberar tensión en la cadera.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Shoulders",
    secondary: ["Lats"],
    highlight: ["shoulders", "lats", "chest"],
    view: "front",
    description:
      "Alivia tensiones en la parte superior del cuerpo, especialmente útil para personas con trabajo de oficina o posturas prolongadas.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Técnica de respiración consciente para mejorar oxigenación, reducir el estrés y conectar con el momento presente.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Ejercicio mental de atención plena (mindfulness) que ayuda a reducir ansiedad, mejorar el enfoque y el bienestar general.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      'The "Smith Machine Split Squat" is a strength exercise performed on the Smith machine, ideal for targeting the legs and glutes. It involves placing one foot forward and the other back, lowering the body until the front thigh is parallel to the ground while the bar slides vertically along the machine. This exercise helps improve stability, correct muscle imbalances, and reduces stress on the back, providing a safe environment for strength training.',
  ...
  },
  {
    ...
    view: "front",
    description:
      "Raise your arm out to the side, placing your hand on a wall or doorway beside you at shoulder height Turn your body away from your arm to stretch the chest, as far as is comfortable",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "On all fours. Arch spine up (cat) then drop it down (cow). Breathe with movement.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Standing position: Place the band under your feet in the middle of your foot and grasp it with a hammer grip.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Glutes",
    secondary: [],
    highlight: ["glutes", "abs", "chest", "upperBack"],
    view: "back",
    description:
  ...
  },
  {
    ...
    view: "back",
    description:
      "Drive through your heel, not your toes, to hit the glute. Don’t hyperextend your lower back at the top.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Lats",
    secondary: ["Shoulders"],
    highlight: ["lats", "shoulders", "upperBack"],
    view: "back",
    description:
      "Keep your chest up and squeeze your shoulder blades at the end. Don’t hunch forward or round your back during the pull.",
  ...
  },
  {
    ...
    view: "back",
    description:
      "A rubber band glute kickback is an exercise performed on hands and knees, where you anchor a resistance band to your foot and kick your heel back and up, squeezing your glute at the top of the movement, while maintaining a stable core and flat back to target and strengthen the gluteal muscles.",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Keep arms straight but not locked, pulling with your lats, not your shoulders. Don’t let your shoulders shrug up during the movement.",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Keep your torso still, pulling the handle down along your side using the outer lat. Don’t twist your body or rotate your torso to cheat the rep.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Keep your elbow tucked to your side like it's superglued there. Don’t rotate your torso — only your forearm should move.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Keep elbow fixed at your side and rotate forearm outward smoothly. Don’t let your wrist or elbow drift upward — stay in one plane.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Lift with your elbows leading, not your hands. Don’t shrug your shoulders; keep traps quiet.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Raise the handle in a slight arc with controlled movement. Don’t swing your torso to start the rep.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Face pulls with band – standing horizontal pull. Grab the band at face height, pull elbows high and wide towards your face while squeezing shoulder blades together. Trains upper back, rear shoulders and improves posture.",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Hang from a pull-up bar, raise your legs to the ceiling. Move lower body from left to right with straight legs like a windshield wiper",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    equipment: "Bodyweight",
    primary: "Glutes",
    secondary: ["Hamstrings", "Calves", "Quads"],
    highlight: ["glutes", "hamstrings", "calves", "quads"],
    view: "back",
    description:
  ...
  },
  {
    ...
    view: "front",
    description:
      "in a cablerack do a side lateral raise with cable in front of you, with focus in tension on the back of your shoulder.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "on a cable rack do a side lateral raise with the cable behind you. focus on tension in the front of the shoulder.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Seated rear delt fly on pec deck machine (facing the machine and extending arms backwards, the hands should be at the height of the shoulders)",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Sit in a prayer position with the soles of your feet gently pressed together. Use your hands to slowly pull your feet inwards towards your groin. Hold for as long as required.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "on a cable rack place cable high, and with a straight arm pull that cable across you from high to low. focus on tension in back shoulder.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Quads",
    secondary: ["Hamstrings"],
    highlight: ["quads", "hamstrings"],
    view: "front",
    description:
      "A combination of squat and deadlift principles with the use of a hex/trap bar, easing stress on the lower back by better centering the weight.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Move your knee forward, keeping your heel on the ground. Hold the position for a couple of seconds and return to the starting position.",
  ...
  },
  {
    ...
    primary: "Lats",
    secondary: ["Shoulders"],
    highlight: ["lats", "shoulders", "biceps", "chest", "upperBack"],
    view: "back",
    description:
  ...
  },
  {
    ...
    highlight: ["shoulders", "hamstrings", "abs"],
    view: "front",
    description:
  ...
  },
  {
    ...
    view: "front",
    description:
      "Attach a resistance band to something solid behind you. Stand away from it, holding it in your hand so it is taut. See the attached youtube video: https://www.youtube.com/watch?v=zdwEWchSjrI .",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "See this instructional video from Stretch Therapy: https://www.youtube.com/watch?v=CrF2iMnn09w .",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Attach one end of resistance band to wall/upright/... at shoulder height. Insert arm into the loop, at the tricep. Step back until band is pulled straight. Pull back elbow and shoulder against the resistance of the band.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Lats",
    secondary: ["Shoulders", "Biceps"],
    highlight: ["lats", "shoulders", "biceps", "upperBack"],
    view: "back",
    description:
  ...
  },
  {
    ...
    view: "back",
    description:
      ": Grab two dumbbells with an overhand grip and lay your forearms across your knees. : Let your wrists flex fully, then extend your wrists.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Chest",
    secondary: ["Shoulders", "Biceps", "Triceps"],
    highlight: ["chest", "shoulders", "biceps", "triceps"],
    view: "front",
    description:
      "Adjust the seat height so that the grips are parallel to your chest. Use your legs to push the foot forward pedal. Bring the handles to the start position. Keep your back and the cushion in contact with the handles, press outwards. Press the handles away from your chest and exhale. Allow the handles to come in gently until they reach your chest. Allow the handles to return to your chest as you exhale.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Walk forward and backward with holding dumbbell on one side without leaning to counter the weight.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Triceps",
    secondary: ["Shoulders"],
    highlight: ["triceps", "shoulders"],
    view: "back",
    description:
      "Start: Lie on your back on the floor with knees bent. Hold weights above your chest with straight arms. Lower: Lower the weights until your upper arms touch the floor. Push: Press the weights back up to the starting position. New note (Notatka): Do not bounce your elbows off the floor. Control the movement.",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Pectoral issolation exercise - full range of motion is best with full contraction and slow negative",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Set weight and grip for the cables in the cage. Take a few steps away, bend over, pull and extend the back at the same time.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Lie on stomach, intertwine fingers behind the head and start raising your head and raise elbows as far as they go.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Lay on the back and lift legs in perpendicular fashion, keeping the knees together. Start making small circles in one direction with both of your knees with very small range of motion, focusing on abs and keeping your back in contact with the floor.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Push one foot back until leg fully extended, concentrating on the having the foot high and pushed back as if pulled. Extend arm forward with focus having the shoulder high up. Unilateral and static hold.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Quads",
    secondary: ["Shoulders"],
    highlight: ["quads", "shoulders"],
    view: "front",
    description:
      "On your fours and raise the knees of the floor ever so slightly. Curl your back out and push back from your shoulders as to resemble a cat making itself look large.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Quads",
    secondary: [],
    highlight: ["quads", "abs", "chest"],
    view: "front",
    description:
      "Sit back, raise feet above the ground with knees bent and start rotating left and right with hands touching the ground every move.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "The parallel bars isometric hold is a static upper-body exercise performed on dip bars (parallel bars). Instead of moving up and down like in a traditional dip, you hold a fixed position under tension.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Shoulders",
    secondary: ["Chest", "Triceps"],
    highlight: ["shoulders", "abs", "chest", "triceps"],
    view: "front",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Place a bench between two cable pulleys and adjust the pulleys so they are at chest/shoulder height when you are seated. Grab the handles with a neutral grip and lean against the upright backrest. Bring your arms together in front of your chest in a controlled motion, focusing on squeezing your chest muscles. Keep your elbows slightly bent throughout the movement. Pause briefly at the top position. Slowly lower your arms back to the starting position while maintaining control of the movement. Repeat for reps.",
  ...
  },
  {
    ...
    equipment: "Cable",
    primary: "Lats",
    secondary: ["Shoulders", "Biceps", "Abs"],
    highlight: ["lats", "shoulders", "biceps", "abs", "chest"],
    view: "back",
    description:
      'The Seated V-Grip Row is a compound pulling exercise performed on a cable machine using a close-grip "V" handle. While seated with your feet braced, you pull the handle toward your midsection, focusing on back thickness and mid-back development.',
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Biceps",
    secondary: ["Shoulders", "Abs"],
    highlight: ["biceps", "shoulders", "abs"],
    view: "front",
    description:
      "The Dumbbell Curl is a classic isolation exercise for the arms. Unlike the Hammer Curl, it involves rotating your wrists (supination) as you lift the weights, which allows for a full contraction of the biceps.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "The Hammer Curl is a popular isolation exercise for the arms, typically performed with dumbbells. Instead of rotating your wrists like a standard bicep curl, you keep a neutral grip (palms facing each other) throughout the entire movement, as if you were holding a hammer.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "front",
    description:
      "The Abdominal Crunch is a classic core isolation exercise performed on the floor or a mat. Unlike a full sit-up, it involves a smaller range of motion where you only lift your shoulders and upper back off the ground, keeping your lower back pressed firmly against the floor.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Very common shoulder exercise. As shown here: https://www.youtube.com/watch?v=vj2w851ZHRM",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Position barbell overhead with narrow overhand grip. Lower forearm behind upper arm with elbows remaining overhead. Extend forearm overhead. Lower and repeat.",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Starting position: Stand tall with your back straight. Steps: Keeping your arms straight, bring them in front of you, move them down, behind your back, then over your head, and back to the initial position. Keep circling your arms as described in step 1.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Starting position: Stand tall with your back straight. Steps: Keeping your arms straight, bring them in front of you, raise them over your head, then continue the motion behind your back and down to the initial position. Keep circling your arms as described in step 1.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Starting position: Sit or stand with your back straight. Steps: Place your hands on your shoulders. Repeatedly rotate both shoulder joints in a circular motion at a moderate pace.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Stand on one leg, with your other leg straight and slightly forward. Bend one knee slowly, descending into a squat and keeping your back and your other leg straight. Slowly raise yourself from the squat, straightening the bent knee and keeping the other leg straight. Repeat.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Shoulders",
    secondary: ["Biceps"],
    highlight: ["shoulders", "biceps", "abs"],
    view: "front",
    description:
  ...
  },
  {
    ...
    view: "front",
    description:
      "The movement is the same as with a regular butterfly, only that the grip is narrow: Sit on the butterfly machine, the feet have a good contact with the floor, the upper arms are parallel to the floor. Press your arms together till the handles are practically together (but aren't!). Go slowly back. The weights should stay all the time in the air.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Back",
    secondary: ["Hamstrings", "Glutes", "Lats", "Abs"],
    highlight: ["hamstrings", "glutes", "lats", "abs", "calves"],
    view: "back",
    description:
  ...
  },
  {
    ...
    view: "back",
    description:
      "This variation of the squat trains the hamstrings and gluteus maximus. It also works the back extensors and abductors.",
  ...
  },
  {
    ...
    primary: "Hamstrings",
    secondary: ["Calves", "Glutes"],
    highlight: ["hamstrings", "calves", "glutes"],
    view: "back",
    description:
  ...
  },
  {
    ...
    primary: "Hamstrings",
    secondary: ["Shoulders", "Biceps"],
    highlight: ["hamstrings", "shoulders", "biceps"],
    view: "back",
    description:
  ...
  },
  {
    ...
    view: "back",
    description:
      "Get into pushup position gripping some dumbbells. Perform one pushup, then drive your left elbo up, bringing the dumbell up to your body. Return the dumbell to starting position. Perform another pushup and then row with the other arm to complete one rep.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    primary: "Shoulders",
    secondary: ["Glutes", "Abs"],
    highlight: ["shoulders", "glutes", "abs", "chest", "upperBack"],
    view: "front",
  ...
  },
  {
    ...
    view: "front",
    description:
      "Stand with your knees slightly bent and your back straight. Hold a dumbbell in each hand, using a neutral grip at your sides.",
  ...
  },
  {
    ...
    equipment: "Bodyweight",
    primary: "Abs",
    secondary: ["Lats", "Chest", "Quads"],
    highlight: ["abs", "lats", "chest", "quads"],
    view: "front",
    description:
  ...
  },
  {
    ...
    highlight: ["lats", "quads", "triceps"],
    view: "back",
    description:
      "Sit on the ground with your legs together and your arms by your sides. Push your body off the ground using your hands, maintaining the same sitting position so that your legs are straight and your feet do not touch the floor. Hold for as long as required.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "As with an L-sit, but allow your feet to touch the floor to support the some of the weight of your legs.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
  ...
  },
  {
    ...
    view: "back",
    description:
      "Belly breathing. Hand on chest stays still, hand on belly rises. 8-10 slow breaths.",
    image: "",
    tips: [],
    pr: "",
    lastUsed: "",
...
export function filterExercises(group: MuscleGroup, query: string): Exercise[] {
  ...
  return EXERCISES.filter((e) => {
    const matchesGroup =
      group === "Alle" ||
      MUSCLE_GROUP_MAP[group].some((m) => e.primary.toLowerCase().includes(m.toLowerCase()))
    const matchesQuery =
      q === "" || e.name.toLowerCase().includes(q) || e.primary.toLowerCase().includes(q)
