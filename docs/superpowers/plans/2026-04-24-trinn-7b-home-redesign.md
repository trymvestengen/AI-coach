# Trinn 7B: Home Screen Redesign — Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Erstatt dagens Home-skjerm med det nye Claude Design-layoutet — kompakt coach-kort, enkle stat-tiles, sosial feed (Friends active today) og "Folk å følge"-seksjon.

**Architecture:** To tasks: (1) legg til CSS-utility-klasser i globals.css som de nye komponentene bruker, (2) skriv om HomeScreen.tsx fullstendig. Ingen backend-endringer, ingen nye ruter. Mock-data for venner og forslag beholdes inlined i komponenten.

**Tech Stack:** Next.js 15, TypeScript, CSS custom properties, inline styles + CSS utility klasser.
...
**Modified:**
- `web/src/app/globals.css` — legg til typography- og komponent-utility-klasser
- `web/src/components/home/HomeScreen.tsx` — full omskriving med nytt layout
...
- [ ] **Step 1: Legg til utility-klasser på slutten av globals.css**

Åpne `/Users/trymvestengen/Desktop/ai-coach/web/src/app/globals.css` og legg til dette helt på slutten av filen:
...
- [ ] **Step 2: TypeScript-sjekk (CSS endres ikke av tsc, men kjør for å bekrefte ingen andre feil)**
...
```bash
git -C /Users/trymvestengen/Desktop/ai-coach add web/src/app/globals.css
git -C /Users/trymvestengen/Desktop/ai-coach commit -m "feat: add CSS utility classes (typography + card/glass)"
```

---

### Task 2: HomeScreen omskriving

**Files:**
- Modify: `web/src/components/home/HomeScreen.tsx`

- [ ] **Step 1: Erstatt hele HomeScreen.tsx**

Skriv over `/Users/trymvestengen/Desktop/ai-coach/web/src/components/home/HomeScreen.tsx` med dette:
...
```bash
git -C /Users/trymvestengen/Desktop/ai-coach add web/src/components/home/HomeScreen.tsx
git -C /Users/trymvestengen/Desktop/ai-coach commit -m "feat: redesign Home screen with social feed layout"
```
