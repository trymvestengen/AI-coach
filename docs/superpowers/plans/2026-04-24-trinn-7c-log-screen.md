# Trinn 7C: Log Screen — Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Bygg treningslogg-skjermen med expanderbare workout-kort, RPE-dots, filterfaner og månedlig sammendrag.

**Architecture:** Tre tasks: (1) legg til `ListIcon` i icons.tsx og bytt ut Workout-fanen i BottomNav til Log, (2) skriv `WorkoutLog.tsx` med alle sub-komponenter, (3) skriv om `log/page.tsx` til riktig import. Ingen backend, ingen nye ruter. Mock-data inlined i komponenten.

**Tech Stack:** Next.js 15, TypeScript, CSS custom properties, inline styles + eksisterende CSS utility klasser (.card, .caption, .metric, .metric-s, .tnum, .screen).
...
**Modified:**
- `web/src/components/ui/icons.tsx` — legg til `ListIcon`
- `web/src/components/layout/BottomNav.tsx` — bytt `/program` → `/log`, `DumbbellIcon` → `ListIcon`, label "Workout" → "Log"
- `web/src/app/(tabs)/log/page.tsx` — skriv om til å importere fra riktig path

**Created:**
- `web/src/components/log/WorkoutLog.tsx` — full Log-skjerm med RpeDots, WorkoutCard, filter, sammendrag

---

### Task 1: ListIcon + BottomNav-oppdatering

**Files:**
- Modify: `web/src/components/ui/icons.tsx`
- Modify: `web/src/components/layout/BottomNav.tsx`

- [ ] **Step 1: Legg til ListIcon i icons.tsx**

Åpne `/Users/trymvestengen/Desktop/ai-coach/web/src/components/ui/icons.tsx` og legg til denne eksporten etter `ChevronIcon`:
...
- [ ] **Step 2: Oppdater BottomNav**

Åpne `/Users/trymvestengen/Desktop/ai-coach/web/src/components/layout/BottomNav.tsx`.

Endre linje 5 (import) fra:
```tsx
...
Endre `tabs`-arrayen (linje 8-13) fra:
```tsx
const tabs = [
...
```bash
git -C /Users/trymvestengen/Desktop/ai-coach add web/src/components/ui/icons.tsx web/src/components/layout/BottomNav.tsx
git -C /Users/trymvestengen/Desktop/ai-coach commit -m "feat: add ListIcon, switch nav tab to /log"
```

---

### Task 2: WorkoutLog-komponenten

**Files:**
- Create: `web/src/components/log/WorkoutLog.tsx`

- [ ] **Step 1: Opprett WorkoutLog.tsx**

Opprett `/Users/trymvestengen/Desktop/ai-coach/web/src/components/log/WorkoutLog.tsx` med dette innholdet:
...
```bash
git -C /Users/trymvestengen/Desktop/ai-coach add web/src/components/log/WorkoutLog.tsx
git -C /Users/trymvestengen/Desktop/ai-coach commit -m "feat: add WorkoutLog component with RpeDots, WorkoutCard, filter tabs"
```

---

### Task 3: Oppdater log/page.tsx
...
Skriv over `/Users/trymvestengen/Desktop/ai-coach/web/src/app/(tabs)/log/page.tsx` med:
...
```bash
git -C /Users/trymvestengen/Desktop/ai-coach add web/src/app/\(tabs\)/log/page.tsx
git -C /Users/trymvestengen/Desktop/ai-coach commit -m "feat: wire /log page to WorkoutLog component"
```
